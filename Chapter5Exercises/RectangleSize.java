...
public class RectangleSize
{
    ...
    public void rectangleHW()  //method rectangleHW is declared, initializes height and width variables.
    {
        ...
        int height = input.nextInt(); //user input is assigned to "height" variable
        System.out.println("Enter rectangle width: "); //user prompt to enter width
        int width = input.nextInt();  // user input is assigned to "width" variable
    }
    public int calculateArea()
    {
        return height * width;
    } // area is calculated using height and width variables.
    ...
    public void printS(boolean isLarge) // method islarge value is then used to print if rectangle is large or not.
    {
        ...
        {
            System.out.println("This is a small rectangle."); //dispaly if area<300, if flase
        }
    }
